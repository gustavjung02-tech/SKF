...
- Có hero, danh sách vị trí tuyển, chi tiết từng vị trí, môi trường làm việc và CTA ứng tuyển.
...
- /images/tuyen-dung/tuyen-dung-kinh-doanh.png
- /images/tuyen-dung/tuyen-dung-ke-toan.png
- /images/tuyen-dung/tuyen-dung-logistics.png
- /images/tuyen-dung/tuyen-dung-kho-giao-nhan.png
...
Khu vực: "TP.HCM, Cần Thơ, Bình Dương, Đà Nẵng, Hà Nội"
Ảnh: /images/tuyen-dung/tuyen-dung-kinh-doanh.png
...
Thu nhập: "Thỏa thuận"
Khu vực: "TP.HCM"
Ảnh: /images/tuyen-dung/tuyen-dung-ke-toan.png
...
Thu nhập: "Thỏa thuận"
Khu vực: "TP.HCM"
Ảnh: /images/tuyen-dung/tuyen-dung-logistics.png
...
Thu nhập: "Thỏa thuận"
Khu vực: "TP.HCM"
Ảnh: /images/tuyen-dung/tuyen-dung-kho-giao-nhan.png
...
Ảnh section: /images/tuyen-dung/tuyen-dung-moi-truong-lam-viec.png

Cách ứng tuyển:
Tiêu đề: "Cách ứng tuyển"
Nội dung:
...
Yêu cầu giao diện:
- Hero có ảnh bên phải trên desktop, ảnh nằm dưới trên mobile.
- Danh sách vị trí dạng card, có ảnh, thu nhập, khu vực, nút "Xem chi tiết" và "Ứng tuyển".
- Mỗi vị trí có phần Mô tả công việc, Yêu cầu, Quyền lợi.
- Có filter hoặc tab theo nhóm: Kinh doanh / Văn phòng / Vận hành.
- Mobile phải dễ đọc, nút ứng tuyển rõ.
- Tone màu: trắng, xám nhạt, xanh thép, điểm nhấn cam/vàng nhẹ.
- Không dùng hiệu ứng rườm rà.
- Nếu có form ứng tuyển, cần các trường: họ tên, số điện thoại, email nếu có, vị trí ứng tuyển, khu vực ứng tuyển, kinh nghiệm, file CV hoặc ghi chú.