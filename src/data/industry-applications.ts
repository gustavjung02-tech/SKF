...
export const industryApplications: IndustryApplication[] = [
  {
    ...
    commonParts: ["Vòng bi SKF", "Gối đỡ SKF", "Truyền động SKF", "Phớt SKF"],
  ...
  },
  {
    ...
    commonParts: ["Vòng bi SKF", "Phớt SKF", "Mỡ bôi trơn SKF"],
  ...
  },
  {
    ...
    commonParts: ["Vòng bi SKF", "Phớt SKF", "Mỡ bôi trơn SKF", "Truyền động SKF"],
  ...
  },
  {
    ...
    description:
      "Hệ băng tải xích, con lăn và cơ cấu truyền động cần khoanh đúng vòng bi, gối đỡ, bôi trơn và nhóm truyền động SKF theo tiến độ vận hành.",
    commonParts: ["Truyền động SKF", "Vòng bi SKF", "Gối đỡ SKF", "Mỡ bôi trơn SKF"],
